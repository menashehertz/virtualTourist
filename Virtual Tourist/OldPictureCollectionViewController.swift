...
class OldPictureCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "<OK", style: .Plain, target: self, action: "cancelAuth")
